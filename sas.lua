...
do
    ...
    local gc = getgc(true)
    if getgenv().logged then 
        log("[i] Reloading bypass..", nil) 
    end
    
    log("[✓] Adonis Bypass loaded!", Color3.fromRGB(88, 137, 184))
                    ...
                    if typeof(v) == "table" then
                        ...
                        if typeof(func) == "function" then
                            ...
                            hookfunction(func, function(a, b, c)
                                log("[!] Blocked anti-cheat call.", Color3.fromRGB(232, 211, 142))
